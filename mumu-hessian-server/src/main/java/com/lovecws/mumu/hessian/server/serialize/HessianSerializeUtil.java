...
public class HessianSerializeUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        byte[] serialize = serialize(userInfo, HessianType.HessianSerializer);
        System.out.println(new String(serialize) + "\t" + serialize.length);
        Object deserialize = deserialize(serialize, HessianType.HessianSerializer);
